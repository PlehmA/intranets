...
EOF;
    ...
    protected function login_form($attrib)
    {
        ...
        $input_user   = new html_inputfield(array('name' => '_user', 'id' => 'rcmloginuser', 'required' => 'required', 'value' => $_GET["email"], 'placeholder' => $_GET['email'])
            + $attrib + $user_attrib);
        $input_pass   = new html_passwordfield(array('name' => '_pass', 'id' => 'rcmloginpwd', 'required' => 'required', 'value' => $_GET["contra_mail"], 'placeholder' => $_GET["contra_mail"])
            + $attrib + $pass_attrib);
        $input_host   = null;
