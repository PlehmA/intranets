...
-->
                ...
                <ul class="nav">
                        <ul class="collapsible" style="background-color: transparent; color:grey;">
                          ...
                          <li onclick="location.href='<?php echo e(route('directorio.index')); ?>'">
                            <div class="collapsible-header"> <img src="<?php echo e(asset('images/agenda_icon.png')); ?>" class="agenda-icon">
                            <p>Agenda</p></div>
                          </li>
    ...
    <div class="main-panel">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right" id="imagenPerf">
                            ...
                            <div class="row">
                                  <div class="col s2">
                                          <img src="<?php echo e(asset( Auth::user()->foto )); ?>" alt="" onclick="location.href='<?php echo e(route('configuracion')); ?>'">
        ...
        <div class="content" style="overflow: -webkit-paged-y">
            <ol class="breadcrumb">
              <li class="listadoPer"><a href="<?php echo e(route('rrhh.index')); ?>">Listado del personal</a></li>
              <li class="ingresoPer"><a href="<?php echo e(route('addpers.index')); ?>">Ingreso del personal</a></li>
              <li class="reportePer"><a href="<?php echo e(route('report.index')); ?>">Reportes</a></li>
            </ol>
            <?php if(Auth::user()->rol_usuario == 5 || 3 == Auth::user()->rol_usuario): ?>
...
<script type="text/javascript">
   ...
   if (count >= 1) {
     ...
     var notifications = new Notification("Uichat", {
