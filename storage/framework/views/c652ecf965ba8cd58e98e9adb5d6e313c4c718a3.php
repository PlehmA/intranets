...
<div id="app">
    ...
    <main class="py-4">
        <div class="container">
            ...
            <div class="col-sm-8 formubtn">
                    ...
                    <?php endif; ?>
                <form action="<?php echo e(url('inicio')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="ipVisitor" value="<?php echo e($_SERVER['REMOTE_ADDR']); ?>">
 ...
 <div id="myModal" class="modals">
        ...
        <div class="modals-content">
                ...
                <a href="<?php echo e(url('img/terminosycondiciones.pdf')); ?>" class="btn btn-desc" download="Términos y condiciones Uitalk">Descargar y entregar en RRHH</a>
