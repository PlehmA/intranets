  ...
  <div class="row">
    ...
    <div class="col s9 m9 l9">
      <div class="col s12 m12 l12">
                ...
                <?php echo Form::open(['route' => ['notes.destroy', $nota['id']], 'method' => 'DELETE']); ?>
      ...
      <div class="col s12 m12 l12">
        ...
        <?php echo Form::open(['route' => ['notes.update', $nota['id']], 'method' => 'PUT']); ?>


        <?php echo e(csrf_field()); ?>


        <textarea name="notas" maxlength="5000" onkeyup="validar();" id="textarea" autofocus><?php echo e($nota['notas']); ?></textarea>
  ...
  <div id="modal1" class="modal">
    <div class="modal-content">
      <h4>Crear nota</h4>
        <hr>
      <div class="row">
   <form class="col s12" id="modalForm" method="POST" action="<?php echo e(route('notes.store')); ?>">
     <?php echo e(csrf_field()); ?>
...
$("#listaizq").hover(function() {
  ...
  $('.btn-borrar').click(function() {
    ...
    $.post(url, form.serialize(), function(result) {
      window.location='<?php echo e(route('notes.index')); ?>';
...
<?php echo $__env->make('notes.app', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>