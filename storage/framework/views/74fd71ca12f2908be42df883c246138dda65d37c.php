...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/chat2.css')); ?>">
...
<style>
    ...
    #frame .content .message-input .wrap .input-loco {
...
-->
                ...
                <ul class="nav">
                        ...
                        <div class="collapsible-header">
                          ...
                          <li>
                                ...
                                <?php if(5 != Auth::user()->rol_usuario && 1 != Auth::user()->tipo_rol): ?>
    ...
    <div class="main-panel">
        <nav class="navbar" data-color="purple" data-image="<?php echo e(asset('img/sidebar-1.jpg')); ?>">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right" id="imagenPerf">
                            <!-- Avatar image -->
                            <div class="row" style="margin-right: -6.6vh;">
                                  <div class="col s2">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <?php echo $__env->yieldContent('chatent'); ?>
            </div>
        </div>
    </div>
</div>
