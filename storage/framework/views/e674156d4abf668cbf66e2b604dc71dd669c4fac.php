...
<body>
        ...
        <div class="row">
            ...
            <div class="row">
                    <div class="col-sm-12">
                        <p style="margin-top: 50px;">Por la presente le expreso mi deseo, pidiendo permiso para ausentarme de mi puesto de trabajo durante los días <?php echo e(date_format($date2 = date_create($data->de), 'd/m/Y')); ?> hasta <?php echo e(date_format($date3 = date_create($data->hasta), 'd/m/Y')); ?> inclusive.</p>
