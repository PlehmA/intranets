...
<form action="<?php echo e(action('CpresiController@store')); ?>" method="POST" id="formularito">
  <!-- Modal content -->
...
<form action="<?php echo e(action('CpresiController@store')); ?>" method="POST" id="formularitox">
  <!-- Modal content -->
  <div class="modal-content scrollbar-info">
    <div class="modal-header">
...
<?php if(Auth::user()->tipo_rol == 2 || Auth::user()->tipo_rol == 1 || Auth::user()->username == 'amcardoso'): ?>
          <div class="input-field col s12">
