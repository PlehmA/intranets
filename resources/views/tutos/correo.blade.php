...
@section('content')
  ...
  <main id="app">
    ...
    <main class="col s9" style="margin-top: -11vh;">
        <div class="row">
          <div class="col s12">
            <a href="{{asset('img/correo/1.png')}}" target="_blank"><img src="{{asset('img/correo/1.png')}}" alt="" class="imagen-box"></a>
            </div>
        </div>
        <div class="row">
          <div class="col s12">
            <a href="{{asset('img/correo/2.png')}}" target="_blank"><img src="{{asset('img/correo/2.png')}}" alt="" class="imagen-box"></a>
            </div>
        </div>
        <div class="row">
          <div class="col s12">
            <a href="{{asset('img/correo/3.png')}}" target="_blank"><img src="{{asset('img/correo/3.png')}}" alt="" class="imagen-box"></a>
            </div>
        </div>
    </main>
    </div>
