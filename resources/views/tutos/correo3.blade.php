...
@section('content')
  ...
  <main id="app">
      ...
      <div class="row">
        <div class="col s3">
            <div class="collection">
                ...
                <a href="{{ url('/correotutos4') }}" class="collection-item active">Eliminar carpeta</a>
    ...
    <main class="col s9" style="margin-top: -11vh;">
        ...
        <div class="row">
          <div class="col s12">
            <a href="{{asset('img/correo/eliminar_carpeta/1.png')}}" target="_blank"><img src="{{asset('img/correo/eliminar_carpeta/1.png')}}" alt="" class="imagen-box"></a>
            </div>
        </div>
        <div class="row">
          <div class="col s12">
            <a href="{{asset('img/correo/eliminar_carpeta/2.png')}}" target="_blank"><img src="{{asset('img/correo/eliminar_carpeta/2.png')}}" alt="" class="imagen-box"></a>
            </div>
        </div>
    </main>
    </div>
