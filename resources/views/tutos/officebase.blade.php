...
@foreach ($baseoffice as $offbase)
<div class="row">

  <div class="col s9">
<video poster="{{ $offbase->foto_video }}" id="player" playsinline controls>
    <source src="{{ url($offbase->video) }}" type="video/mp4">
</video>
...
@endforeach
  ...
  <div class="col s3 container">
    <ul class="pagination">
        <li class="waves-effect"><a href="{{ $baseoffice->previousPageUrl() }}" class="anterior" title="Video anterior"><i class="material-icons">skip_previous</i></a></li>
        <li class="waves-effect"><a href="{{ $baseoffice->url($baseoffice->currentPage()) }}">{{ $baseoffice->currentPage() }}</a></li>
        <li class="waves-effect"><a href="{{ $baseoffice->nextPageUrl() }}" class="siguiente" title="Siguiente video"><i class="material-icons">skip_next</i></a></li>
      </ul>
  </div>
</div>
