...
<body>
        ...
        <div class="row">
            ...
            <div class="row">
                    <div class="col-sm-12">
                        <p style="margin-top: 50px;">Por la presente le expreso mi deseo de ejercitar el derecho a los días de permiso retribuido por motivo del nacimiento de mi hijo/a.
