...
<body>
        <div class="row">
            ...
            <div class="row">
                    <div class="col-sm-12">
                        <p style="margin-top: 50px;">Por la presente le expreso mi deseo de ejercitar el derecho a los días de permiso retribuido por motivo de enfermedad grave de familiar.
                        Por todo ello solicito permiso para ausentarme de mi puesto de trabajo durante los días {{ date_format($date2 = date_create($data->de), 'd/m/Y') }} hasta {{ date_format($date3 = date_create($data->hasta), 'd/m/Y') }} inclusive, 
