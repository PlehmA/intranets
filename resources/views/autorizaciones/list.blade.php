...
<!-- USUARIOS -->
    ...
    <div class="row">
            @if(2 != Auth::user()->tipo_rol)<h3 class="center-align">Gestiones</h3>@endif
            @if(2 == Auth::user()->tipo_rol) <h3 class="center-align">Gestiones propias</h3> @endif
        </div>
        <table id="table_id3">
            <thead>
                <tr>
            ...
            @if(true === $auser->estado_jefe && true === $auser->estado_rrhh)
                    ...
                    <a href="{{ action('AutorizationController@show', $auser->id) }}" type="submit" class="grey btn btn-small" style="border:none; background-color: #26a69a !important;" target="_blank">Descargar formulario <i class="fas fa-download"></i></a>
