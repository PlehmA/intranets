...
<div class="row">
        {!! Form::open(['route' => 'autorizaciones.store', 'method' => 'POST', 'class' => 'formulito']) !!}
        <div class="col s4">
                <ul class="collection">
                                            ...
                                            <div class="col m6 offset-m1">
                                              <div class="card">
                                                <div class="card-content white-text">
                                                  ...
                                                  <hr>
                                                  <label>Desde: </label> <br> <input type="date" style="color: black" class="browser-default" value="{{ date('Y-m-d') }}" name="dematrimonio">
                                                  <br>
                                        ...
                                        <div class="col m6 offset-m1">
                                          <div class="card">
                                            <div class="card-content white-text">
                                              ...
                                              <hr>
                                              <label>Desde: </label> <br> <input type="date" style="color: black" class="browser-default" value="{{ date('Y-m-d') }}" name="decasahijos">
                                              <br>
                                              <label>Hasta: </label> <br> <input type="date" class="browser-default" style="color: black" value="{{ date('Y-m-d') }}" name="hastacasahijos"><p style="color: black;display: inline-block;margin-left: 5px;">inclusive</p>
                                            </div>
                                            ...
                                            <div class="card-content">
                                                ...
                                                <div class="col">
                                                        <div class="col s5 offset-s1">
                                                                <label>Desde: </label> <input type="date" name="demudanza" value="{{ date('Y-m-d') }}" class="browser-default">
                                                             </div>
                                        ...
                                        <div class="col m6 offset-m1">
                                          <div class="card">
                                            <div class="card-content white-text">
                                              ...
                                              <hr>
                                              <label>Desde: </label> <br> <input type="date" style="color: black" class="browser-default" value="{{ date('Y-m-d') }}" name="deenffamiliar">
                                              <br>
                                        ...
                                        <div class="col m6 offset-m1">
                                          <div class="card">
                                            <div class="card-content white-text">
                                              ...
                                              <hr>
                                              <label>Fecha: </label> <br> <input type="date" style="color: black" class="browser-default" value="{{ date('Y-m-d') }}" name="depemestudio">
                                              <br>
                                              <label>Horario: </label> <br> <input type="time" class="browser-default" style="color: black" value="{{ date('H:i:s') }}" name="hastapemestudio">
                                            </div>
                              ...
                              <div class="col m6 offset-m1">
                                <div class="card">
                                  <div class="card-content white-text">
                                    ...
                                    <hr>
                                    <label>Fecha: </label> <br> <input type="date" style="color: black" class="browser-default" value="{{ date('Y-m-d') }}" name="delicjuzcom">
                                    <br>
                                    <label>Horario: </label> <br> <input type="time" class="browser-default" style="color: black" value="{{ date('H:i:s') }}" name="hastalicjuzcom">
                                  </div>
                                  <p class="center-align" style="font-weight: 700;"><b><i> Esta licencia se deberá solicitar con 72 horas de anticipación.</i></b></p>
                ...
                <main v-else-if="formu == 11">
                  ...
                  <div class="row">
                          <div class="col m6 offset-m1">
                            <div class="card">
                              <div class="card-content white-text">
                                <span class="card-title" style="color: black">Licencia por reunión de padres en jardín o colegios</span>
                                <hr>
                                <label>Fecha: </label> <br> <input type="date" style="color: black" class="browser-default" value="{{ date('Y-m-d') }}" name="delicjuzcom">
                                <br>
                                <label>Horario: </label> <br> <input type="time" class="browser-default" style="color: black" value="{{ date('H:i:s') }}" name="hastalicjuzcom">
                      ...
                      <div class="col m6 offset-m1">
                        <div class="card">
                          <div class="card-content white-text">
                            ...
                            <label>Fecha: </label> <br> <input type="date" style="color: black" class="browser-default" value="{{ date('Y-m-d') }}" name="delicjuzcom">
                            <br>
                            <br> <input type="hidden" class="browser-default" style="color: black" value="{{ date('Y-m-d') }}" name="hastalicjuzcom">
