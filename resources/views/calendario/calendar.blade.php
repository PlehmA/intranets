       ...
       <div class="row">
         <div class="col m7 xl7">
            <select name="invitados[]" multiple class="selectInvitados">
                ...
                @foreach ($users as $compas)
                  <option value="{{$compas->id}}">{{$compas->name}}</option>
                @endforeach
              </select>
         </div>
...
@if(Auth::user()->tipo_rol == 2 || Auth::user()->tipo_rol == 1 || Auth::user()->rol_usuario == 9)
          <div class="input-field col s12">
...
<div id="modalExpEventos" class="modal">
    <div class="modal-content" style="width: 55%">
        ...
        <div class="modal-body">
          <form action="{{route('exportevent')}}" method="POST">
            @csrf
            <div class="row">
              <div class="col s12 xl4">
                  <label for="deevento">De: </label>
                  <input type="text" id="deevento" name="deevento" class="datepicker deevento" value="{{date('d/m/Y')}}">
              </div>
              <div class="col s12 xl4">
                  <label for="hastaevento">Hasta: </label>
                  <input type="text" name="hastaevento" id="hastaevento" class="datepicker hastaevento" value="{{date('d/m/Y')}}">
                </div>
            </div>
